...
impl ProjectRegistry {
    ...
    pub fn anchor_document(
        ...
        let mut history = storage::get_document_history(&env, &project_id)
        ...
        let mut anchorer_projects = storage::get_anchorer_projects(&env, &owner)
            .unwrap_or_else(|_| Vec::new(&env));
    ...
    pub fn get_projects_by_anchorer(
        env: Env,
        anchorer: Address,
